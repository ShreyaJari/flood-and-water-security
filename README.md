...
- Coxon, G. et al. (2020). "CAMELS-GB: hydrometeorological time series and landscape attributes for 671 catchments in Great Britain." *Earth System Science Data*, 12, 2459–2483. https://doi.org/10.5194/essd-12-2459-2020 (UK Centre for Ecology & Hydrology, Open Government Licence)
- UK National River Flow Archive [Data set]. UK Centre for Ecology & Hydrology. https://nrfa.ceh.ac.uk/ (station metadata)
- OpenStreetMap contributors. Infrastructure data via the Overpass API. https://www.openstreetmap.org/copyright
- European Space Agency/Copernicus. Sentinel-2 L2A [Data set]. Retrieved via Google Earth Engine, accessed [add your access date].
